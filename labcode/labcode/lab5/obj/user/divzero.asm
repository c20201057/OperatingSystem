...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d4:	4d0a8a93          	addi	s5,s5,1232 # 8006a0 <main+0x17a>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
...
main(void) {
  ...
  800528:	e406                	sd	ra,8(sp)
  80052a:	e022                	sd	s0,0(sp)
  80052c:	0800                	addi	s0,sp,16
    cprintf("value is %d.\n", 1 / zero);
  80052e:	00001797          	auipc	a5,0x1
  800532:	ad278793          	addi	a5,a5,-1326 # 801000 <zero>
  800536:	439c                	lw	a5,0(a5)
  800538:	4705                	li	a4,1
  80053a:	02f747bb          	divw	a5,a4,a5
  80053e:	2781                	sext.w	a5,a5
  800540:	85be                	mv	a1,a5
  800542:	00000517          	auipc	a0,0x0
  800546:	37e50513          	addi	a0,a0,894 # 8008c0 <error_string+0xc8>
  80054a:	b57ff0ef          	jal	8000a0 <cprintf>
    panic("FAIL: T.T\n");
  80054e:	00000617          	auipc	a2,0x0
  800552:	38260613          	addi	a2,a2,898 # 8008d0 <error_string+0xd8>
  800556:	45a5                	li	a1,9
  800558:	00000517          	auipc	a0,0x0
  80055c:	38850513          	addi	a0,a0,904 # 8008e0 <error_string+0xe8>
