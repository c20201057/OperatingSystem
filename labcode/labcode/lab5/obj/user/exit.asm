...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	65c50513          	addi	a0,a0,1628 # 800690 <main+0x14e>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	65a50513          	addi	a0,a0,1626 # 8006b0 <main+0x16e>
...
exit(int error_code) {
  ...
  800138:	58450513          	addi	a0,a0,1412 # 8006b8 <main+0x176>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800198:	53c78793          	addi	a5,a5,1340 # 8006d0 <main+0x18e>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f0:	760a8a93          	addi	s5,s5,1888 # 80094c <main+0x40a>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800412:	69a78793          	addi	a5,a5,1690 # 800aa8 <error_string>
  ...
  800426:	2de60613          	addi	a2,a2,734 # 800700 <main+0x1be>
  ...
  800438:	2bc60613          	addi	a2,a2,700 # 8006f0 <main+0x1ae>
  ...
  8004aa:	243d8d93          	addi	s11,s11,579 # 8006e9 <main+0x1a7>
  ...
  8004e6:	20650513          	addi	a0,a0,518 # 8006e8 <main+0x1a6>
  ...
  8004fa:	1f2d8d93          	addi	s11,s11,498 # 8006e8 <main+0x1a6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
int
main(void) {
  800542:	7179                	addi	sp,sp,-48
    int pid, code;
    cprintf("I am the parent. Forking the child...\n");
  800544:	00000517          	auipc	a0,0x0
  800548:	28450513          	addi	a0,a0,644 # 8007c8 <main+0x286>
main(void) {
  80054c:	f406                	sd	ra,40(sp)
  80054e:	f022                	sd	s0,32(sp)
    cprintf("I am the parent. Forking the child...\n");
  800550:	b51ff0ef          	jal	8000a0 <cprintf>
    if ((pid = fork()) == 0) {
  800554:	befff0ef          	jal	800142 <fork>
  800558:	10050063          	beqz	a0,800658 <main+0x116>
  80055c:	842a                	mv	s0,a0
        yield();
        yield();
        exit(magic);
    }
  ...
  80055e:	85aa                	mv	a1,a0
  800560:	00000517          	auipc	a0,0x0
  800564:	2a850513          	addi	a0,a0,680 # 800808 <main+0x2c6>
  800568:	b39ff0ef          	jal	8000a0 <cprintf>
    }
    assert(pid > 0);
  80056c:	0c805763          	blez	s0,80063a <main+0xf8>
    /* debug instrumentation: print values around waitpid to diagnose failures */
    cprintf("[debug] parent: pid=%d, about to wait\n", pid);
  800570:	85a2                	mv	a1,s0
  800572:	00000517          	auipc	a0,0x0
  800576:	2ee50513          	addi	a0,a0,750 # 800860 <main+0x31e>
  80057a:	b27ff0ef          	jal	8000a0 <cprintf>
    cprintf("I am the parent, waiting now..\n");
  80057e:	00000517          	auipc	a0,0x0
  800582:	30a50513          	addi	a0,a0,778 # 800888 <main+0x346>
  800586:	b1bff0ef          	jal	8000a0 <cprintf>

    int ret = waitpid(pid, &code);
  80058a:	086c                	addi	a1,sp,28
  80058c:	8522                	mv	a0,s0
  80058e:	bbdff0ef          	jal	80014a <waitpid>
    cprintf("[debug] waitpid returned %d, code=%d\n", ret, code);
  800592:	4672                	lw	a2,28(sp)
    int ret = waitpid(pid, &code);
  800594:	85aa                	mv	a1,a0
    cprintf("[debug] waitpid returned %d, code=%d\n", ret, code);
  800596:	e42a                	sd	a0,8(sp)
  800598:	00000517          	auipc	a0,0x0
  80059c:	31050513          	addi	a0,a0,784 # 8008a8 <main+0x366>
  8005a0:	b01ff0ef          	jal	8000a0 <cprintf>
    assert(ret == 0 && code == magic);
  8005a4:	65a2                	ld	a1,8(sp)
  8005a6:	e9b9                	bnez	a1,8005fc <main+0xba>
  8005a8:	4772                	lw	a4,28(sp)
  8005aa:	00001797          	auipc	a5,0x1
  8005ae:	a567a783          	lw	a5,-1450(a5) # 801000 <magic>
  8005b2:	04f71563          	bne	a4,a5,8005fc <main+0xba>

    ret = waitpid(pid, &code);
  8005b6:	086c                	addi	a1,sp,28
  8005b8:	8522                	mv	a0,s0
  8005ba:	b91ff0ef          	jal	80014a <waitpid>
  8005be:	85aa                	mv	a1,a0
    cprintf("[debug] waitpid(second) returned %d\n", ret);
  8005c0:	e42a                	sd	a0,8(sp)
  8005c2:	00000517          	auipc	a0,0x0
  8005c6:	32e50513          	addi	a0,a0,814 # 8008f0 <main+0x3ae>
  8005ca:	ad7ff0ef          	jal	8000a0 <cprintf>
    assert(ret != 0 && wait() != 0);
  8005ce:	65a2                	ld	a1,8(sp)
  8005d0:	c5a9                	beqz	a1,80061a <main+0xd8>
  8005d2:	b73ff0ef          	jal	800144 <wait>
  8005d6:	c131                	beqz	a0,80061a <main+0xd8>
    cprintf("waitpid %d ok.\n", pid);
  8005d8:	85a2                	mv	a1,s0
  8005da:	00000517          	auipc	a0,0x0
  8005de:	35650513          	addi	a0,a0,854 # 800930 <main+0x3ee>
  8005e2:	abfff0ef          	jal	8000a0 <cprintf>

    cprintf("exit pass.\n");
  8005e6:	00000517          	auipc	a0,0x0
  8005ea:	35a50513          	addi	a0,a0,858 # 800940 <main+0x3fe>
  ...
  800600:	2d468693          	addi	a3,a3,724 # 8008d0 <main+0x38e>
  800604:	00000617          	auipc	a2,0x0
  800608:	23460613          	addi	a2,a2,564 # 800838 <main+0x2f6>
  80060c:	45fd                	li	a1,31
  80060e:	00000517          	auipc	a0,0x0
  800612:	24250513          	addi	a0,a0,578 # 800850 <main+0x30e>
  800616:	a11ff0ef          	jal	800026 <__panic>
    assert(ret != 0 && wait() != 0);
  80061a:	00000697          	auipc	a3,0x0
  80061e:	2fe68693          	addi	a3,a3,766 # 800918 <main+0x3d6>
  800622:	00000617          	auipc	a2,0x0
  800626:	21660613          	addi	a2,a2,534 # 800838 <main+0x2f6>
  80062a:	02300593          	li	a1,35
  80062e:	00000517          	auipc	a0,0x0
  800632:	22250513          	addi	a0,a0,546 # 800850 <main+0x30e>
  800636:	9f1ff0ef          	jal	800026 <__panic>
    assert(pid > 0);
  80063a:	00000697          	auipc	a3,0x0
  80063e:	1f668693          	addi	a3,a3,502 # 800830 <main+0x2ee>
  800642:	00000617          	auipc	a2,0x0
  800646:	1f660613          	addi	a2,a2,502 # 800838 <main+0x2f6>
  80064a:	45e1                	li	a1,24
  80064c:	00000517          	auipc	a0,0x0
  800650:	20450513          	addi	a0,a0,516 # 800850 <main+0x30e>
  800654:	9d3ff0ef          	jal	800026 <__panic>
        cprintf("I am the child.\n");
  800658:	00000517          	auipc	a0,0x0
  80065c:	19850513          	addi	a0,a0,408 # 8007f0 <main+0x2ae>
  800660:	a41ff0ef          	jal	8000a0 <cprintf>
        yield();
  800664:	ae9ff0ef          	jal	80014c <yield>
        yield();
  800668:	ae5ff0ef          	jal	80014c <yield>
        yield();
  80066c:	ae1ff0ef          	jal	80014c <yield>
        yield();
  800670:	addff0ef          	jal	80014c <yield>
        yield();
  800674:	ad9ff0ef          	jal	80014c <yield>
        yield();
  800678:	ad5ff0ef          	jal	80014c <yield>
        yield();
  80067c:	ad1ff0ef          	jal	80014c <yield>
        exit(magic);
  800680:	00001517          	auipc	a0,0x1
  800684:	98052503          	lw	a0,-1664(a0) # 801000 <magic>
  800688:	aa5ff0ef          	jal	80012c <exit>
